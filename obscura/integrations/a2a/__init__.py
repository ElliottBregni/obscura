...
if TYPE_CHECKING:
    ...
    from obscura.integrations.a2a.openclaw_bridge import OpenClawBridge, OpenClawBridgeConfig, OpenClawContext
...
def __getattr__(name: str) -> object:
    ...
    if name == "EventMapper":
        ...
        return EventMapper
    if name in ("OpenClawBridge", "OpenClawBridgeConfig", "OpenClawContext"):
