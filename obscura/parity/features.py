...
from obscura.parity.models import ParityFeature
...
FEATURES: tuple[ParityFeature, ...] = (
    ...
    ParityFeature(
        "session_fork",
        "Session Fork",
        "Fork/branch session where supported.",
        weight=1.5,
    ),
    ParityFeature(
    ...
    ParityFeature(
        ...
        "Emit tool start/delta/end lifecycle.",
    ),
    ParityFeature(
        "native_event_passthrough",
    ...
    ParityFeature(
        ...
        "Support native Claude permission modes.",
    ),
    ParityFeature(
        "copilot_event_stream",
        "Copilot Event Stream",
        "Support Copilot SDK event stream semantics.",
    ),
    ParityFeature(
        "localllm_health_models",
        "LocalLLM Health + Models",
        "Support model list and health checks.",
    ),
)
