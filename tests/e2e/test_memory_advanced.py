...
class TestMemoryTransactions:
    ...
    def test_transaction_set_and_get(self, client):
        ...
        resp = client.post("/api/v1/memory/transaction", json={
            "operations": [
                {"op": "set", "namespace": "txn-test", "key": "key1", "value": "value1"},
                {"op": "get", "namespace": "txn-test", "key": "key1"},
                {"op": "set", "namespace": "txn-test", "key": "key2", "value": {"nested": "data"}},
            ]
        })
...
class TestMemoryImportExport:
    ...
    def test_import_with_overwrite(self, client):
        ...
        resp = client.post("/api/v1/memory/import?overwrite=true", json={
            "data": import_data
        })
    ...
    def test_import_without_overwrite(self, client):
        ...
        resp = client.post("/api/v1/memory/import?overwrite=false", json={
            "data": import_data
        })
