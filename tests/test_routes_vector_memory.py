...
class TestVectorMemorySet:
    def test_set_vector_memory(self, client):
    ...
    def test_set_vector_memory_defaults(self, client):
...
class TestVectorMemorySearch:
    ...
    def test_search_with_rerank(self, client):
        resp = client.get("/api/v1/vector-memory/search", params={
            "q": "test",
            "rerank": "true",
            "recency_weight": "0.3",
    ...
    def test_search_with_memory_types(self, client):
        resp = client.get("/api/v1/vector-memory/search", params={
            "q": "test",
    ...
    def test_search_with_date_from(self, client):
        resp = client.get("/api/v1/vector-memory/search", params={
            "q": "test",
    ...
    def test_search_with_date_to(self, client):
        resp = client.get("/api/v1/vector-memory/search", params={
            "q": "test",
...
class TestVectorMemoryRoutedSearch:
    def test_routed_search(self, client):
