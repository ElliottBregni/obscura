"""Tests for obscura_cli.py — Command-line interface."""
...
from obscura_cli import cli, ObscuraCLI
...
class TestCLIAgentCommands:
    ...
    def test_agent_spawn(self, runner, mock_client):
        ...
        with patch.dict("os.environ", {"OBSCURA_URL": "http://test"}):
            with patch("obscura_cli.ObscuraCLI", return_value=mock_client):
    ...
    def test_agent_spawn_missing_name(self, runner):
    ...
    def test_agent_list(self, runner, mock_client):
    ...
    def test_agent_list_empty(self, runner, mock_client):
    ...
    def test_agent_list_with_status_filter(self, runner, mock_client):
    ...
    def test_agent_run(self, runner, mock_client):
    ...
    def test_agent_status(self, runner, mock_client):
    ...
    def test_agent_stop(self, runner, mock_client):
    ...
    def test_agent_quick(self, runner, mock_client):
...
class TestCLIMemoryCommands:
    ...
    def test_memory_set(self, runner, mock_client):
        """Test memory set command."""
        with patch.dict("os.environ", {"OBSCURA_URL": "http://test"}):
            with patch("obscura_cli.ObscuraCLI", return_value=mock_client):
                result = runner.invoke(cli, [
                    "memory", "set", "mykey", "myvalue",
                    "--namespace", "test",
                ])
    ...
    def test_memory_set_json(self, runner, mock_client):
    ...
    def test_memory_get_found(self, runner, mock_client):
    ...
    def test_memory_get_not_found(self, runner, mock_client):
    ...
    def test_memory_delete_success(self, runner, mock_client):
    ...
    def test_memory_delete_not_found(self, runner, mock_client):
    ...
    def test_memory_search(self, runner, mock_client):
...
class TestCLIVectorCommands:
    ...
    def test_vector_remember(self, runner, mock_client):
    ...
    def test_vector_remember_auto_key(self, runner, mock_client):
    ...
    def test_vector_recall(self, runner, mock_client):
    ...
    def test_vector_recall_empty(self, runner, mock_client):
...
class TestCLIServerCommand:
    ...
    @patch("uvicorn.run")
    def test_serve_default(self, mock_run, runner):
    ...
    @patch("uvicorn.run")
    def test_serve_custom_port(self, mock_run, runner):
...
class TestCLIHealthCommand:
    ...
    def test_health_ok(self, runner, mock_client):
    ...
    def test_health_error(self, runner, mock_client):
...
class TestCLIErrorHandling:
    ...
    def test_api_error_handling(self, runner, mock_client):
...
class TestCLIOptions:
    ...
    def test_global_url_option(self, runner, mock_client):
        """Test --url global option."""
        with patch("obscura_cli.ObscuraCLI") as mock_cli_class:
    ...
    def test_global_token_option(self, runner, mock_client):
