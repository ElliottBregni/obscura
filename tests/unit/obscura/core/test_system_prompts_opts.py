...
def _default_prompt_has_browser_section() -> bool:
    ...
    from obscura.core.system_prompts import _BROWSER_SECTION_MARKER, get_default_system_prompt
...
def test_browser_section_absent_when_disabled() -> None:
    ...
    from obscura.core.system_prompts import _BROWSER_SECTION_MARKER, compose_system_prompt
...
def test_browser_section_auto_detect_no_browser() -> None:
    ...
    with patch(
        "obscura.core.system_prompts._is_browser_running", return_value=False
    ):
...
def test_browser_section_auto_detect_browser_running() -> None:
    ...
    with patch(
        "obscura.core.system_prompts._is_browser_running", return_value=True
    ):
        result = compose_system_prompt()
    assert _BROWSER_SECTION_MARKER in result
...
def test_split_browser_section_with_marker() -> None:
    ...
    from obscura.core.system_prompts import _BROWSER_SECTION_MARKER, _split_browser_section
