...
class TestRunServe:
    ...
    def test_serve_calls_uvicorn(self) -> None:
        ...
        from obscura.cli import _run_serve, build_parser  # pyright: ignore[reportPrivateUsage]
    ...
    def test_serve_passes_args_to_uvicorn(self) -> None:
        ...
        assert (
            ...
            or call_kwargs[0][0] == "obscura.server:create_app"
        )
...
class TestRunTui:
    def test_tui_missing_dependencies(self) -> None:
        ...
        from obscura.cli import _run_tui, build_parser  # pyright: ignore[reportPrivateUsage]
        ...
        def mock_import(name: str, *a: Any, **kw: Any) -> Any:
            if name == "obscura.tui.app":
                raise ImportError("No module named 'obscura.tui.app'")
            return original_import(name, *a, **kw)
...
class TestAsyncRun:
    ...
    async def test_run_empty_prompt_from_stdin(
        ...
        with patch("obscura.cli.sys") as mock_sys:
...
class TestTelemetryHelpers:
    def test_init_cli_telemetry_no_crash(self) -> None:
        ...
        from obscura.cli import _init_cli_telemetry  # pyright: ignore[reportPrivateUsage]
    ...
    def test_get_cli_logger_returns_logger(self) -> None:
        ...
        from obscura.cli import _get_cli_logger  # pyright: ignore[reportPrivateUsage]
