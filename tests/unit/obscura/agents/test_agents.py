...
class TestBackendSpecificAgents:
    ...
    async def test_start_uses_expected_backend_model(
        ...
        with patch("obscura.agent.agents.ObscuraClient") as mock_client_ctor:
...
class TestAgentStart:
    ...
    async def test_start_with_mcp_enabled(self, runtime: AgentRuntime) -> None:
        ...
        with patch("obscura.agent.agents.ObscuraClient") as MockClient:
            ...
            with patch("obscura.providers.mcp_backend.MCPBackend") as MockMCPBackend:
    ...
    async def test_start_with_heartbeat(self, runtime: AgentRuntime) -> None:
        ...
        with patch("obscura.agent.agents.ObscuraClient") as MockClient:
            ...
            with patch("obscura.heartbeat.AgentHeartbeatClient") as MockHB:
    ...
    async def test_start_heartbeat_failure(self, runtime: AgentRuntime) -> None:
        ...
        with patch("obscura.agent.agents.ObscuraClient") as MockClient:
            ...
            with patch(
                "obscura.heartbeat.AgentHeartbeatClient",
...
class TestAgentStop:
    ...
    async def test_stop_with_cancel_scope_error(self, runtime: AgentRuntime) -> None:
        ...
        mock_client = AsyncMock()
        mock_client.stop = AsyncMock(side_effect=RuntimeError("cancel scope blah"))
        agent.client = mock_client
    ...
    async def test_stop_with_other_runtime_error(self, runtime: AgentRuntime) -> None:
        ...
        mock_client = AsyncMock()
        mock_client.stop = AsyncMock(side_effect=RuntimeError("some other error"))
        agent.client = mock_client
